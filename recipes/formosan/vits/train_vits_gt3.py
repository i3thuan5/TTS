...
dataset_config = [
    BaseDatasetConfig(
        dataset_name=f"formosan_dict_{language}_train_gt3",
        formatter="formosan",
        meta_file_train=f"formosan_dict_{language}_concat.json",
        path="/home/wayne/Corpora/formosan_clean_denoised_train_gt3",
        language=language,
    )
...
dataset_config += [
    BaseDatasetConfig(
        dataset_name=f"klokah_{language}_train_gt3",
        formatter="formosan",
...
dataset_config += [
    BaseDatasetConfig(
        dataset_name=f"klokah_{language}_eval_gt3",
        formatter="formosan",
